...
const services = [
  {
    ...
    image: whatimg1,
    checklist: [
      { text: "Aenean quam ornare curabitur blandit.", icon: righttick },
      { text: "Nullam quis risus eget urna mollis ornare leo.", icon: righttick },
      { text: "Etiam porta euismod mollis natoque ornare.", icon: righttick },
    ],
  },
  {
